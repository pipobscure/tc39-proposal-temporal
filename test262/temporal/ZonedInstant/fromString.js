...
const two = temporal.ZonedInstant.fromString('1976-11-18T15:23:30.450000100+01:00[Europe/Vienna]');
...
assert.throws(Error, ()=>{
  temporal.ZonedInstant.fromString('1976-11-18T15:23:30.450000100+03:00[Europe/Vienna]');
});
assert.throws(Error, ()=>{
