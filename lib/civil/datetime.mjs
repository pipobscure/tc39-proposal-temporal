...
export class CivilDateTime {
  ...
  withZone(zone, filter) {
    return Zoned.fromCivilDateTime(zone, this, filter);
  }
  toDate() {
  ...
  toTime() {
    const { hours, minutes, seconds, milliseconds, microseconds, nanoseconds } = this;
    return new CivilTime(hours, minutes, seconds, milliseconds, microseconds, nanoseconds);
  }
