...
export function toEpoch({ year = 1970, month = 1, day = 1, hour = 0, minute = 0, second = 0, millisecond = 0 } = {}, zone, offset) {
  const ts = Date.UTC(year, month - 1, day, hour, minute, second, millisecond);

  const offsetI = guessOffset(ts, offset || zone);
...
export function guessOffset(ts, zone) {
