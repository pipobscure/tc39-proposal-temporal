...
export class Zoned {
  ...
  static fromSeconds(seconds, zone) {
    return new Zoned(Instant.fromSeconds(seconds), zone);
  }
  static fromMilliseconds(milliseconds, zone) {
    return new Zoned(Instant.fromMilliseconds(milliseconds), zone);
  }
  static fromMicroseconds(micros, zone) {
    return new Zoned(Instant.fromMicroseconds(micros), zone);
  }
  static fromNanoseconds(nanos, zone) {
    return new Zoned(Instant.fromNanoseconds(nanos), zone);
  }
}
